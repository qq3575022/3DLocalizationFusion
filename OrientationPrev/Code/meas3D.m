...
load('r/accT.mat');load('r/gyroT.mat');load('r/magT.mat');load('r/time.mat');
...
load('r/magx.mat'); load('r/magy.mat'); load('r/magz.mat');
load('r/gyrox.mat');load('r/gyroy.mat'); load('r/gyroz.mat');
load('r/accx.mat'); load('r/accy.mat');  load('r/accz.mat');
