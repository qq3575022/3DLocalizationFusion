...
data=readtable('../Data/2second.csv','Delimiter', ',');
...
accx = medfilt1(acc_data_x_zt,500);
accy = medfilt1(acc_data_y_zt,500);
accz = medfilt1(acc_data_z_zt,500);
...
plot(accT, acc_data_z_zt)
hold on
plot(accT, accx, 'LineWidth', 2)
hold on
plot(accT, accy, 'LineWidth', 2)
hold on
plot(accT, accz, 'LineWidth', 2)
xlabel('time [s]')
