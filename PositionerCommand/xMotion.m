...
sp =sprintf('SP %i,%i,%i',(x(i,1)-x(i-1,1))/4,(x(i,2)-x(i-1,2))/2,(x(i,3)-x(i-1,3))/2)%SET TRAVEL DISTANCE: Print STRING of SET DISTANCE command from user input
ac =sprintf('AC %i,%i,%i',(x(i,1)-x(i-1,1))/4,(x(i,2)-x(i-1,2))/2,(x(i,3)-x(i-1,3))/3)%SET TRAVEL DISTANCE: Print STRING of SET DISTANCE command from user input
dc =sprintf('DC %i,%i,%i',(x(i,1)-x(i-1,1))/4,(x(i,2)-x(i-1,2))/2,(x(i,3)-x(i-1,3))/3)%SET TRAVEL DISTANCE: Print STRING of SET DISTANCE command from user input
