function [time2, magD3, magD4, magD5, magD6, magD7, phaseD2] = filterAvg2(magD1, phaseD1)



%d2=unwrap(phaseD1);
magD2 = zeros(1, round(length(magD1)/200));
magD3 = zeros(1, round(length(magD1)/200));
magD4 = zeros(1, round(length(magD1)/200));
magD5 = zeros(1, round(length(magD1)/200));
magD6 = zeros(1, round(length(magD1)/200));
magD7 = zeros(1, round(length(magD1)/200));

for i = 2:1:length(magD1)/200
     magD2(i) = mean(magD1(200*(i-1)+1:200*i));
