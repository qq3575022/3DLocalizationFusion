...
%  y(1,1) =  0.3*cos(w(1)) + 1.51; y(2,1) = 0; y(3,1) = 0;
 x(1,1) = -0.3045*sin(w(1)); x(2,1) = 0; x(3,1) = 0;
 y(1,1) =  0.3045*cos(w(1)); y(2,1) = 0; y(3,1) = 0;
...
%      x(1,n) =  0.3*sin(-w(n)) + 1.95;%2;
    x(1,n) =  0.3045*sin(-w(n));%2;
    x(2,n) = -0.3045*cos(-w(n))*w_v(n);
    x(3,n) = -0.3045*sin(-w(n))*w_v(n)^2 - 0.3045*cos(-w(n))*w_a(n);
    
%      y(1,n) =  0.3*cos(-w(n)) + 1.51;%1.5;
    y(1,n) =  0.3045*cos(-w(n));%1.5;
    y(2,n) =  0.3045*sin(-w(n))*w_v(n);
    y(3,n) = -0.3045*cos(-w(n))*w_v(n)^2 + 0.3045*sin(-w(n))*w_a(n);
